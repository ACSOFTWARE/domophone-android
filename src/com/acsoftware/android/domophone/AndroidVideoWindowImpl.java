...
public class AndroidVideoWindowImpl {
	...
	public void init() {
		...
		mVideoRenderingView.getHolder().addCallback(new Callback(){
			public void surfaceChanged(SurfaceHolder holder, int format,
				...
				Trace.d("mVideoRenderingView", "Video display surface is being changed.");
				if (!useGLrendering) {
				...
				Trace.d("mVideoRenderingView", "Video display surface changed");
			}

			public void surfaceCreated(SurfaceHolder holder) {
			    Trace.d("mVideoRenderingView", "Video display surface created");
			}
			...
			public void surfaceDestroyed(SurfaceHolder holder) {
				...
				Trace.d("mVideoRenderingView", "Video display surface destroyed"); 
			}
		});
		...
		if (mVideoPreviewView != null) {
			mVideoPreviewView.getHolder().addCallback(new Callback(){
				public void surfaceChanged(SurfaceHolder holder, int format,
						int width, int height) {
					//Trace.i("Video preview surface is being changed.");
					if (mListener!=null) 
						mListener.onVideoPreviewSurfaceReady(AndroidVideoWindowImpl.this, mVideoPreviewView);
					//Trace.w("Video preview surface changed");
				}

				public void surfaceCreated(SurfaceHolder holder) {
					//Trace.w("Video preview surface created");
				}

				public void surfaceDestroyed(SurfaceHolder holder) {
					if (mListener!=null)
						mListener.onVideoPreviewSurfaceDestroyed(AndroidVideoWindowImpl.this);
					//Trace.d("Video preview surface destroyed"); 
				}
			});
		}
	...
	public Surface getSurface(){
		//if (useGLrendering)
			//Trace.e("View class does not match Video display filter used (you must use a non-GL View)");
	...
	public void setOpenGLESDisplay(int ptr) {
		//if (!useGLrendering)
			//Trace.e("View class does not match Video display filter used (you must use a GL View)");
		Trace.d("WideoWindowImpl", "setOpenGLESDisplay");
